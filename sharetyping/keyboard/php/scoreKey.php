    ...
    <div class="container">
        <div class="strap">
            <div id="total">
                ...
                <p id="kekka">
                    <span class="first">ミスの数:</span><span><?php if (!empty($_SESSION['user_id'])) {
                                                                echo $row['miss'];
                                                            } else {
                                                                echo $_SESSION['miss'];
                                                            } ?></span><span class="nagai">回</span>
                </p>
                <p id="kekka"> <span class="first"> 正答率:</span><span><?php if (!empty($_SESSION['user_id'])) {
                                                                            echo $row['rate'];
                                                                        } else {
                                                                            echo $_SESSION['rate'];
                                                                        } ?></span>%</p>
                <p id="kekka">
                    あなたのレベルは<span class="red"><?php if (!empty($_SESSION['user_id'])) {
                                                    echo $row['level'];
                                                } else {
                                                    echo $_SESSION['level'];
                                                } ?></span>です</p>
