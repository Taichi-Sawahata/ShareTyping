        ...
        <h3 class="lesson"><span class="sankaku"></span>ログイン</h3>
            ...
            ?>
                ...
                <input type="hidden" name="csrf_token" value="<?php echo $csrf_token;?>">
                    <div><div class="start"><span class="hissu">※</span><span class="font2">メールアドレス</span></div>
                    <div><input type="text" name="user_mail" id="input"></div></div>
                    <div><div class="start"><span class="hissu">※</span><span class="font2">パスワード</span></div>
